<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AlquilarVehiculo.aspx.cs" Inherits="RentACar.Pages.AlquilarVehiculo" %>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <asp:DropDownList ID="ddlTipo" runat="server" BackColor="#1CCEF4" ForeColor="#F2F6FE" CssClass="ddl">
                           <asp:ListItem>Seleccione...</asp:ListItem>
                            <asp:ListItem>Automovil</asp:ListItem>
                            <asp:ListItem>Moto</asp:ListItem>
                            <asp:ListItem>Camión</asp:ListItem>
                            <asp:ListItem>Buseta</asp:ListItem>
                             </asp:DropDownList>
                    </div>
